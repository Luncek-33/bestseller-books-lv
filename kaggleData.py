...
#from lekcija17 import submit_button

books_df = pd.read_csv("archive/bestsellers_with_categories_2022_03_27.csv")

st.title("Bestselling Books Analysis")
st.write("This app analyzes the Amazon Top Selling books from 2009. to 2022.")

#Sidebar: Add new book data
...
with st.sidebar.form("book_form"):
    ...
    submitButton= st.form_submit_button(label="Add Book")
...
if submitButton:
    ...
    books_df.to_csv("bestsellers_with-categories_2022_03_07.csv", index=False)
